...
if(isset($_SESSION['log'])&&($_SESSION['log']==true))
{
    ...
    <div class = "web_page" >
        <form action= 'resultOfSearchBooksToDelete.php' method = 'POST'>
        <div id='searchbox'><input type='textSearch' name="search" placeholder ='Wyszukaj książki' required></div>
        <button name = 'searchButton' class= 'button' >Wyszukaj </button> 
        </div>
 <?php
}
else
