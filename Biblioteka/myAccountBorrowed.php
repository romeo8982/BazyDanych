...
if(isset($_SESSION['log'])&&($_SESSION['log']==true))
{
    ...
    while($rowBorrowedBooks = $resultBorrowedBooks->fetch_assoc()){     //petla do wyswietlania tabeli
        
              echo " <br><table id = 'tableResult' border ='1' cellpadding = '10' cellspacing = '0' align = 'center'>";
              ...
              if($rowBorrowedBooks['extendedDateOfReturn']==0)
              echo("NIE");
              else
              echo("TAK");
              echo " <form action= 'returnOrExtendBook.php' method = 'POST'> ";
              echo " <button name = 'return' value = '$idBook' class = 'buttonSearch' > Zwroc ksiazke </button> "; 
              echo " <button name = 'extend' value = '$idBook' class = 'button'> Przedluz </button> ";
