...
if(isset($_SESSION['log'])&&($_SESSION['log']==true)&&!empty($_POST))
{
    ...
    $_SESSION['idUserToDelete'] = $_POST['delete'];
	$idUser = $_SESSION['idUserToDelete'];
    if($sqlDeleteUser = $polaczenie->query("DELETE FROM person WHERE id = $idUser")===TRUE)
	{
		?>
		<h1>Użytkownik został usunięty</h1>
		<script>
